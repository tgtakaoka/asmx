...
void Asm8048Init(void)
{
    ...
    p = AddAsm(versionName, LITTLE_END, ADDR_16, LIST_24, I8048_opcdTab,
               &I8048_DoCPUOpcode, NULL, NULL);
//    p = AddAsm(versionName, LITTLE_END, ADDR_16, LIST_24, I8048_opcdTab,
//               &I8048_DoCPUOpcode, &I8048_DoCPULabelOp, &I8048_PassInit);
    AddCPU(p, "8048",  CPU_8048);
//    AddCPU(p, "8041",  CPU_8041);
//    AddCPU(p, "8021",  CPU_8021);
//    AddCPU(p, "8022",  CPU_8022);
}